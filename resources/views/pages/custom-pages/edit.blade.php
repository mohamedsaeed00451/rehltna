...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between mb-4">
        <div class="my-auto">
            <h4 class="content-title mb-0 my-auto text-dark">Edit Page</h4>
        </div>
    </div>
        ...
        <div class="col-xl-12">
            ...
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-body p-4">
                    <form action="{{ route('custom-pages.update', $page->id) }}" method="POST" id="editForm">
                        @csrf
                        @method('PUT')
                                ...
                                @foreach(get_active_langs() as $lang)
                                    <div class="{{ colClass() }} mb-3">
                                        ...
                                        <input type="text" name="title_{{ $lang }}" class="form-control form-control-lg"
                                               value="{{ old('title_'.$lang, $page->{'title_'.$lang}) }}" required>
                                    </div>
                                @endforeach
                                ...
                                @foreach(get_active_langs() as $lang)
                                    <div class="col-12 mb-4">
                                        ...
                                        <textarea name="content_{{ $lang }}" id="content_{{ $lang }}"
                                                  class="form-control summernote">{{ old('content_'.$lang, $page->{'content_'.$lang}) }}</textarea>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="media-selector-group">
                                    <input type="text" id="meta_img" name="meta_img" readonly
                                           ...
                                           value="{{ $page->meta_img ? asset($page->meta_img) : '' }}"
                                           onclick="$('#btn_meta').click()">
                                ...
                                <div id="preview_meta_img">
                                    @if($page->meta_img)
                                        <div class="media-preview-card"><img src="{{ asset($page->meta_img) }}"
                                                                             width="200"></div>
                                    @endif
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <textarea name="meta_description_{{ $lang }}" class="form-control"
                                                          rows="3">{{ old('meta_description_'.$lang, $page->{'meta_description_'.$lang}) }}</textarea>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">Meta Keywords</label>
                                                <textarea name="meta_keywords_{{ $lang }}" class="form-control"
                                                          rows="3">{{ old('meta_keywords_'.$lang, $page->{'meta_keywords_'.$lang}) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="d-flex justify-content-between mt-5 pt-3 border-top">
                            ...
                            <div class="ms-auto">
                                ...
                                <button type="submit" class="btn btn-success px-5" id="submitBtn" style="display:none;">
                                    <i class="fas fa-check-circle me-1"></i> Update Page
                                </button>
                            </div>
                        </div>
