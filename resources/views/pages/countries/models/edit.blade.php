...
<div class="modal fade" id="editCountryModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form method="POST" id="editCountryForm" class="w-100">
            @method('put')
            @csrf
            <div class="modal-content custom-modal-content">
                ...
                <div class="modal-header custom-modal-header d-flex justify-content-between align-items-center">
                    <h5 class="modal-title fw-bold" style="color: #1e293b; font-size: 1.3rem;">
                        <i class="fas fa-edit me-2" style="color: #4f46e5;"></i> Update Country
                    </h5>
                ...
                <div class="modal-body custom-modal-body">
                    @if(hasEnglish())
                        <div class="mb-4">
                            <label class="form-label custom-label">Title (English)</label>
                    ...
                    @if(hasArabic())
                        <div class="mb-4">
                            <label class="form-label custom-label">Title (Arabic)</label>
                            <input type="text" name="title_ar" id="edit-title_ar" class="form-control custom-input"
                                   placeholder="مثال: الولايات المتحدة" required dir="rtl">
                        </div>
                    @endif

                    <div class="mb-2">
                        <label class="form-label custom-label">Status</label>
                        <select name="status" id="edit-country-status" class="form-select custom-select" required>
                ...
                <div class="modal-footer custom-modal-footer d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn-modal-save">
                        <i class="fas fa-sync-alt me-1"></i> Update Country
                    </button>
                </div>
