...
{{-- Create Modal --}}
<div class="modal fade" id="CountryCreate" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form action="{{ route('countries.store') }}" method="POST" class="w-100">
            @csrf
            <div class="modal-content custom-modal-content">
                ...
                <div class="modal-header custom-modal-header d-flex justify-content-between align-items-center">
                    <h5 class="modal-title fw-bold" style="color: #1e293b; font-size: 1.3rem;">
                        <i class="fas fa-globe-americas me-2" style="color: #4f46e5;"></i> Add New Country
                    </h5>
