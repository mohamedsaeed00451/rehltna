            ...
            <form id="editForm" method="POST">
                ...
                <div class="modal-header d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                        <div
                            ...
                            <i class="las la-edit" style="color: #10b981; font-size: 1.6rem;"></i>
                        </div>
                        <h5 class="modal-title mb-0">Update Magnet Type</h5>
                    </div>
                ...
                <div class="modal-body">
                    @foreach(get_active_langs() as $lang)
                        <div class="mb-3">
                            ...
                            <input type="text" name="name_{{ $lang }}" id="edit-name_{{ $lang }}"
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light rounded-pill px-4 fw-bold"
                            style="border-radius: 14px; padding: 12px 25px;" data-bs-dismiss="modal">Discard
                    </button>
                    <button type="submit" class="btn btn-save-marketing shadow-sm"
                            style="background: #059669 !important;">
                        <i class="las la-sync me-2"></i> Update Record
                    </button>
                </div>
            </form>
        </div>
