...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between mb-4">
        <div class="my-auto">
            <h4 class="content-title mb-0 my-auto text-dark">Create Member</h4>
        </div>
    </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="media-selector-group">
                                        <input type="text" id="img" name="img" readonly
                                               placeholder="Select photo from gallery..."
                                               onclick="$('#btn_img').click()">
                                        <button type="button" id="btn_img"
                        ...
                        <div class="d-flex justify-content-between mt-5 pt-3 border-top">
                            ...
                            <div class="ms-auto">
                                ...
                                <button type="submit" class="btn btn-success px-5" id="submitBtn" style="display:none;">
                                    <i class="fas fa-check-circle me-1"></i> Create Member
                                </button>
                            </div>
                        </div>
