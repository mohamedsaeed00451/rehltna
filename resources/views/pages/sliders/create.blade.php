...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between mb-4">
        <div class="my-auto">
            <h4 class="content-title mb-0 my-auto text-dark">Create Slider</h4>
        </div>
    </div>
                            ...
                            <div class="row">
                                @foreach(get_active_langs() as $lang)
                                    <div class="{{ colClass() }} mb-4">
                                        <label class="form-label">Banner ({{ strtoupper($lang) }}) <span
                                                class="text-muted">(Image or Video)</span></label>
                        ...
                        <div class="d-flex justify-content-between mt-5 pt-3 border-top">
                            ...
                            <div class="ms-auto">
                                ...
                                <button type="submit" class="btn btn-success px-5" id="submitBtn" style="display:none;">
                                    <i class="fas fa-check-circle me-1"></i> Create Slider
                                </button>
                            </div>
                        </div>
