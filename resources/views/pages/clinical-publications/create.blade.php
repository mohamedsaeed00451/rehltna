    ...
    <div class="breadcrumb-header justify-content-between mb-4">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 ms-2 mb-0">/ Create Clinical Publication</span>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="card-body">
                        ...
                        <form action="{{ route('clinical-publications.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <button class="btn btn-primary mt-3" type="submit">Create Clinical Publication</button>
                        </form>
