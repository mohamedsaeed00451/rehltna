...
@section('content')
    ...
    <div class="hero-section">
        <div>
            <h3 class="mb-2 fw-bold" style="letter-spacing: -0.5px;">Manage Cities</h3>
            <p class="mb-0 opacity-75 fw-medium">Organize cities and link them to their respective states and
                countries.</p>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <div
                                                class="toggle-status-btn main-toggle {{ $city->status == 1 ? 'main-toggle-success on' : 'main-toggle-danger of' }}"
                                                data-id="{{ $city->id }}">
                                                <span></span>
                                            </div>
                                        </div>
                ...
                @if($cities->hasPages())
                    <div class="card-footer bg-transparent border-0 p-4 mt-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <p class="text-muted small mb-0 fw-bold">Records: {{ $cities->firstItem() }}
                                - {{ $cities->lastItem() }} / Total: {{ $cities->total() }}</p>
                            {{ $cities->links() }}
                        </div>
                    </div>
                @endif
    ...
    @include('pages.cities.models.create')
    @include('pages.cities.models.edit')
...
@section('scripts')
    <script>
        ...
        $(document).on('click', '.toggle-status-btn', function () {
            ...
            let url = "{{ route('cities.change.status', ':id') }}";
