...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between mb-4">
        <div class="my-auto">
            <h4 class="content-title mb-0 my-auto text-dark">Create Lead Magnet</h4>
        </div>
    </div>
        ...
        <div class="col-xl-12">
            ...
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-body p-4">
                    <form action="{{ route('lead-magnets.store') }}" method="POST" id="createForm">
                        @csrf
                                    ...
                                    <div class="{{ colClass() }} mb-4">
                                        ...
                                        <div class="media-selector-group">
                                            <input type="text" id="banner_{{ $lang }}" name="banner_{{ $lang }}"
                                                   readonly placeholder="Choose banner from gallery..."
                        ...
                        <div class="d-flex justify-content-between mt-5 pt-3 border-top">
                            ...
                            <div class="ms-auto">
                                ...
                                <button type="submit" class="btn btn-success px-5" id="submitBtn" style="display:none;">
                                    <i class="fas fa-check-circle me-1"></i> Create Lead Magnet
                                </button>
                            </div>
                        </div>
