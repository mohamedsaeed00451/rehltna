                ...
                <div class="card-body p-4">
                    <form action="{{ route('items.update', $item->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="step-content" id="step-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h6 class="text-dark fw-bold mb-0"><i class="fas fa-route me-2 text-primary"></i> Trip Route (Steps)</h6>
                            ...
                            <div id="route-repeater">
                                @if(isset($item) && $item->routes && $item->routes->count() > 0)
                                    @foreach($item->routes as $route)
                                        ...
                                        <div class="row route-row mb-3 align-items-center p-3 rounded" style="background-color: #fff; border: 1px dashed #ced4da;">
