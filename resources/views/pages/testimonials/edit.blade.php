...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between mb-4">
        <div class="my-auto">
            <h4 class="content-title mb-0 my-auto text-dark">Edit Testimonial</h4>
        </div>
    </div>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('testimonials.update', $testimonial->id) }}" method="POST"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="media-selector-group">
                                    <input type="text" id="image" name="image"
                                           value="{{ $testimonial->image ? asset($testimonial->image) : '' }}" readonly
                                ...
                                <div id="preview_image">
                                    @if($testimonial->image)
                                        <div class="media-preview-card">
                                            <img src="{{ asset($testimonial->image) }}" width="120" height="120"
                        ...
                        <div class="mt-4 pt-3 border-top text-end">
                            <a href="{{ route('testimonials.index') }}" class="btn btn-light px-4 me-2">Cancel</a>
