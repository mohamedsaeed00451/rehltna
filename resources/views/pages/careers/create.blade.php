    ...
    <div class="breadcrumb-header justify-content-between mb-4">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 ms-2 mb-0">/ Create Career</span>
            </div>
        </div>
    </div>
                ...
                <div class="card-header pb-0">
                    <div class="card-body">
                        ...
                        <form action="{{ route('careers.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="career_type_id" class="form-control" required>
                                        <option selected disabled>-- Select Career Type --</option>
                                        @foreach($careerTypes as $careerType)
                                            <option
                                                value="{{ $careerType->id }}">{{ hasEnglish() ? $careerType->title_en : $careerType->title_ar }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <button class="btn btn-primary mt-3" type="submit">Create Career</button>
                        </form>
